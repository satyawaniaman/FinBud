...
// Replace with a sharper, higher-quality stock market image
const LoginImg =
  "https://images.unsplash.com/photo-1560221328-12fe60f83ab8?q=80&w=2074&auto=format&fit=crop";
  ...
  const handleSignin: any = async () => {
    ...
    try {
      ...
      if (checkAuth.payload?.isSignedIn) {
        // Don't redirect, just show success and stay on the page
        setAuthError("Login successful! Please continue browsing stocks.");
      } else {
