    ...
    if (!validationResult.valid) {
      ...
      try {
        ...
        if (!checkAuth?.error?.error) {
          // Just update the UI to show success but stay on the same page
          setAuthError("Signup successful! Please continue browsing stocks.");
          // Clear form data
